...
Terminal:
    To download the MPJ Express
    wget https://sourceforge.net/projects/mpjexpress/files/mpj-v0_44.tar.gz/download -O mpj-v0_44.tar.gz
    ...
    mpjrun.sh -np 4 ArrAvg  // Specified value of n=4 here 
...
# kill any old orbd/server processes
killall java 2>/dev/null
killall orbd 2>/dev/null

# start ORBD
echo "Starting ORBD..."
orbd -ORBInitialPort 1056 -ORBInitialHost localhost &
sleep 2

# start server
echo "Starting Server..."
java ReverseServer -ORBInitialPort 1056 -ORBInitialHost localhost &
sleep 2
